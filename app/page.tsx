...
export default function Home() {
	return (
		// <div className="relative h-full pl-2 pr-2 text-gray-800 bg-gradient-to-br from-sky-100 via-white to-sky-100">
		// 	<header className="relative m-auto h-[56px] max-w-4xl pt-3">
		// 		<div className="absolute left-0 right-0 z-20 flex items-center justify-between top-3">
		...
		// 			<svg className="absolute inset-0 top-0 w-full h-full text-gray-900" xmlns="http://www.w3.org/2000/svg">
		// 				<defs>
		// 					<pattern
		// 						id="pattern"
		// 						width="32"
		...
		// 			</svg>
		// 		</div>
		// 		<div className="max-w-md px-3 mx-auto mt-16 mb-16 text-center sm:max-w-lg sm:px-0">
		...
		// 				<span className="text-transparent bg-gradient-to-r from-amber-400 to-orange-600 bg-clip-text">
		// 					Expenses.
		// 				</span>
		// 			</h1>
		...
		// 				<li className="mt-4 text-base tracking-tight before::h-2 sm:text-lg">
		...
		// 				Features.
		// 			</h2>
		// 			<div className="grid justify-center grid-cols-1 gap-10 p-5 mt-10 lg:grid-cols-2 lg:gap-20">
		// 				<Features />
		// 			</div>
		// 		</div>
		...
		// 			</p>
		// 			<div className="flex flex-col w-full mt-8 sm:flex-row">
		...
		// 						<p className="mt-2 mb-2 text-gray-300">Free forever with limits.</p>
		// 						<p className="mt-4">
		// 							<span className="text-3xl font-extrabold text-white">$ 0</span>
		// 							<span className="text-base text-gray-100"> / month</span>
		// 						</p>
		// 						<div className="flex flex-col justify-center mt-4 mb-0 ml-1 text-left text-white ">
		...
		// 						</div>
		// 						<a
		// 							className="block w-full py-2 mt-10 text-sm font-semibold text-center text-black bg-white rounded-md hover:bg-gray-200"
		...
		// 						<p className="mt-2 mb-2 text-gray-300">Access to all premium features.</p>
		// 						<p className="mt-4">
		...
		// 						</div>
		// 						<a
		// 							className="flex justify-center w-full py-2 mt-10 text-sm font-semibold text-center text-black bg-white rounded-md hover:bg-gray-200"
		// 							href="https://app.expense.fyi/signup"
		// 						>
		// 							Get started
		// 						</a>
		...
		// 				Proudly{' '}
		// 				<span className="text-transparent bg-gradient-to-r from-blue-400 to-sky-600 bg-clip-text">
		// 					Open Sourced!
		// 				</span>
		// 			</h2>
