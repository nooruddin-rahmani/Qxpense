...
export default function Incomespage() {
  ...
  const prepareChartData = () => {
    return metrics.monthlyIncomes
      .map((income) => ({
        month: new Date(income.month).toLocaleString("default", {
          month: "short",
        }),
    ...
    <div className="flex min-h-screen dark: w-full flex-col">
        ...
        <Sheet>
          ...
          <SheetContent side="left">
            <nav className="grid gap-6 text-lg font-medium">
              ...
              <Link href="/dashboard/incomes" className="hover:text-foreground">
                Incomes
              </Link>
              <Link
                href="/dashboard/expenses"
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Total Income in Six Months</CardTitle>
